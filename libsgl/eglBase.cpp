...
static const FGLExtensionMap gExtensionMap[] = {
	...
	{ "glIsRenderbufferOES",
		(__eglMustCastToProperFunctionPointerType)&glIsRenderbufferOES },
	{ "glBindRenderbufferOES",
		(__eglMustCastToProperFunctionPointerType)&glBindRenderbufferOES },
	{ "glDeleteRenderbuffersOES",
		(__eglMustCastToProperFunctionPointerType)&glDeleteRenderbuffersOES },
	{ "glGenRenderbuffersOES",
		(__eglMustCastToProperFunctionPointerType)&glGenRenderbuffersOES },
	{ "glRenderbufferStorageOES",
		(__eglMustCastToProperFunctionPointerType)&glRenderbufferStorageOES },
	{ "glGetRenderbufferParameterivOES",
		(__eglMustCastToProperFunctionPointerType)&glGetRenderbufferParameterivOES },
	{ "glIsFramebufferOES",
		(__eglMustCastToProperFunctionPointerType)&glIsFramebufferOES },
	{ "glIsFramebufferOES",
		(__eglMustCastToProperFunctionPointerType)&glIsFramebufferOES },
	{ "glBindFramebufferOES",
		(__eglMustCastToProperFunctionPointerType)&glBindFramebufferOES },
	{ "glDeleteFramebuffersOES",
		(__eglMustCastToProperFunctionPointerType)&glDeleteFramebuffersOES },
	{ "glGenFramebuffersOES",
		(__eglMustCastToProperFunctionPointerType)&glGenFramebuffersOES },
	{ "glCheckFramebufferStatusOES",
		(__eglMustCastToProperFunctionPointerType)&glCheckFramebufferStatusOES },
	{ "glFramebufferRenderbufferOES",
		(__eglMustCastToProperFunctionPointerType)&glFramebufferRenderbufferOES },
	{ "glFramebufferTexture2DOES",
		(__eglMustCastToProperFunctionPointerType)&glFramebufferTexture2DOES },
	{ "glGetFramebufferAttachmentParameterivOES",
		(__eglMustCastToProperFunctionPointerType)&glGetFramebufferAttachmentParameterivOES },
	{ "glGenerateMipmapOES",
		(__eglMustCastToProperFunctionPointerType)&glGetFramebufferAttachmentParameterivOES },
};
